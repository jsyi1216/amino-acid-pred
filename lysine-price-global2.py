...
df.columns
df['LYSINE_PRICE_M'].plot()
df['WHEAT_PRICE_M'].plot()
df['CORN_PRICE_M'].plot()
df['SOYBEAN_PRICE_M'].plot()
df['EXCHANGE_M'].plot()
df['WTI_PRICE_M'].plot()
df['PPI'].plot()
df['CPI'].plot()
...
plt.plot(preprocessing.scale(df['LYSINE_PRICE_M']), '.', color='red', markersize=5)
plt.plot(preprocessing.scale(df['WHEAT_PRICE_M']), color='black')
plt.plot(preprocessing.scale(df['LYSINE_PRICE_M']), '.', color='red', markersize=5)
plt.plot(preprocessing.scale(df['CORN_PRICE_M']), color='black')
plt.plot(preprocessing.scale(df['LYSINE_PRICE_M']), '.', color='red', markersize=5)
plt.plot(preprocessing.scale(df['SOYBEAN_PRICE_M']), color='black')
plt.plot(preprocessing.scale(df['LYSINE_PRICE_M']), '.', color='red', markersize=5)
plt.plot(preprocessing.scale(df['EXCHANGE_M']), color='black')
plt.plot(preprocessing.scale(df['LYSINE_PRICE_M']), '.', color='red', markersize=5)
plt.plot(preprocessing.scale(df['WTI_PRICE_M']), color='black')
plt.plot(preprocessing.scale(df['LYSINE_PRICE_M']), '.', color='red', markersize=5)
